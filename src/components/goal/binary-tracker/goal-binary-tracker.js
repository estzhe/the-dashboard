...
import template from 'app/components/goal/binary-tracker/template.hbs';
import historyEditorTemplate from 'app/components/goal/binary-tracker/history-editor.hbs';
