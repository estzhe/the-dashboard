...
import DailyStore from 'app/lib/daily-store.js';
import BaseComponent from 'app/components/base-component.js';
import Charts from 'app/components/goal/charts.js';
import { Temporal } from '@js-temporal/polyfill';
import template from 'app/components/goal/numeric-tracker/template.hbs';
import historyEditorTemplate from 'app/components/goal/numeric-tracker/history-editor.hbs';
