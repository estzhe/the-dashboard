...
export default class WeatherGraphics
{
     ...
     * 
     * @param {HTMLCanvasElement | OffscreenCanvas} canvas - Width is recommended to be divisible by `values.length`.
     * @param {number[]} values 
     * @param {{
     *      start: { value: number, color: string },
     *      end: { value: number, color: string }
     * }} gradient
     * @param {number} randomnessFactor - 1 for every pixel filled, 2 for every other pixel filled on average, etc.
     */
    static drawStrips(canvas, values, gradient, randomnessFactor)
    {
     ...
     * 
     * @param {HTMLCanvasElement | OffscreenCanvas} canvas - Width is recommended to be divisible by `data[].values.length`.
     * @param {{
     *      values: number[],
     *      color: string,
     ...
     * }[]} data
     */
    static drawUpsideDownStackedBars(canvas, data)
    {
        Argument.notNullOrUndefined(canvas, "canvas");
